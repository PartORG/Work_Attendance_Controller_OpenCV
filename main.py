...
# load images
control_picture = fr.load_image_file('Employees/Ievgen Perederieiev.jpg')
test_picture = fr.load_image_file('Employees/Brad Pitt.jpg')
...
cv2.putText(test_picture,
            ...
            1,
            (0, 255, 0) if distance < 0.6 else (0, 0, 255),
            2)
